...
/**
 * Builds the location tracking container for Discord.
 * @param verifiedAccounts The list of verified VRChat accounts
 * @param consents The consent status for each account
 * @param usernames The mapped usernames for each account
 * @param friendsMap The friends status map
 * @returns The container builder with the location tracking UI
 */
