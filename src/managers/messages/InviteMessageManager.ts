...
export class InviteMessageManager {
   ...
   */
  static async getInviteMessages(
    userId: string,
    messageType: InviteMessageType,
  ): Promise<InviteMessage[]> {
    return await listInviteMessages({ userId, messageType });
...
export const invite = {
  message: {
    comeHangOut:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][0],
    comeHangOutWithEveryone:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][1],
    meetSomeone:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][2],
    playGame:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][3],
    exploring:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][4],
    findFriends:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][5],
    ...
    watchVideos:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][8],
    lookAtWorld:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][9],
    findAvatars:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][10],
    helpMe:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Message][11],
  },
  response: {
    busy: InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][0],
    joinInMinutes:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][1],
    afk: InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][2],
    logOff:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][3],
    event: InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][4],
    joinMyInstance:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][5],
    askOwner:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][6],
    discordMsg:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][7],
    privateInstance:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][8],
    fullInstance:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][9],
    beRightBack:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][10],
    working:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Response][11],
  },
  request: {
    inviteMe:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Request][0],
    pleaseInvite:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Request][1],
    longTime:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Request][2],
    ...
    showYou:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Request][5],
    checkWorld:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Request][6],
    ...
    explore:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Request][10],
    hangOut:
      InviteMessageManager.DEFAULT_MESSAGES[InviteMessageType.Request][11],
  },
  requestresponse: {
    busy: InviteMessageManager.DEFAULT_MESSAGES[
      InviteMessageType.RequestResponse
    ][0],
    joinOffYou:
      InviteMessageManager.DEFAULT_MESSAGES[
        InviteMessageType.RequestResponse
      ][1],
    afk: InviteMessageManager.DEFAULT_MESSAGES[
      InviteMessageType.RequestResponse
    ][2],
    logOff:
      InviteMessageManager.DEFAULT_MESSAGES[
...
export async function syncAllInviteMessages(userId?: string) {
  ...
  for (const type of Object.values(InviteMessageType)) {
    const defaults =
      InviteMessageManager.DEFAULT_MESSAGES[type as InviteMessageType];
    for (let slot = 0; slot < defaults.length; slot++) {
      ...
      await syncInviteMessageIfDifferent({
        ...
        type: type as InviteMessageType,
        slot,
        expected,
      });
    }
