...
export class SettingsAttendanceSubGroup {
  ...
  @Slash({ name: "add-channel", description: "Add a channel to the enrolled channels for attendance." })
  async addChannel(
    @SlashOption({
      name: "channel",
  ...
  @Slash({ name: "remove-channel", description: "Remove a channel from the enrolled channels for attendance." })
  async removeChannel(
    @SlashOption({
      name: "channel",
